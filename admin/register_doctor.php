        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    ...
                    <a href="register_doctor.php" class="list-group-item list-group-item-action active">Register Doctor</a>
            ...
            <div class="col-md-10">
                ...
                <?php if (isset($_GET['success'])) echo '<div class="alert alert-success">Doctor registered successfully.</div>'; ?>
