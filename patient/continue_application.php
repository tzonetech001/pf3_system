            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4>Continue Application</h4>
                    </div>
                    <div class="card-body">
                        <form action="continue.php" method="GET">
                            <div class="mb-3">
                                <label for="pf3_number" class="form-label" id="continue-label">Enter PF3 Number</label>
                                <input type="text" class="form-control" id="pf3_number" name="pf3" required placeholder="PF3-XXXXXX">
                            </div>
                            <button type="submit" class="btn btn-primary w-100" id="continue-button">Continue</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        const translations = {
            en: {
                ...
                track: 'Track Status',
                login: 'Login',
                continueHeader: 'Continue Application',
                continueLabel: 'Enter PF3 Number',
            ...
            sw: {
                ...
                track: 'Fuatilia Hali',
                login: 'Ingia',
                continueHeader: 'Endelea Maombi',
                continueLabel: 'Weka Nambari ya PF3',
        ...
        function updateLanguage(lang) {
            ...
            if (header) header.textContent = translations[lang].continueHeader;
            if (label) label.textContent = translations[lang].continueLabel;
            if (button) button.textContent = translations[lang].continueButton;
        }
